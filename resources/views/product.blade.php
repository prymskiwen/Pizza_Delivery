...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <h3>{{Currency::getCurrentCurrency()}}{{ Currency::getPriceWithCurrentCurrency($product->price) }}</h3>
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        <div class="caption text-center">
                            ...
                            <p>{{Currency::getCurrentCurrency()}}{{ Currency::getPriceWithCurrentCurrency($product->price) }}</p>
                            </a>
                        </div> <!-- end caption -->
                    </div> <!-- end thumbnail -->
                </div> <!-- end col-md-3 -->
