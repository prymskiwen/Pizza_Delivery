            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{Currency::getCurrentCurrency()}}{{ Currency::getPriceWithCurrentCurrency($item->subtotal) }}</td>
                        <td class=""></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>{{Currency::getCurrentCurrency()}}{{ Currency::getPriceWithCurrentCurrency(Cart::instance('default')->subtotal()) }}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td>{{Currency::getCurrentCurrency()}}{{ Currency::getPriceWithCurrentCurrency(Cart::instance('default')->tax()) }}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="table-bg">{{Currency::getCurrentCurrency()}}{{ Currency::getPriceWithCurrentCurrency(Cart::total()) }}</td>
